<x-visitor-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 lg:space-y-8">
        ...
        <div class="border-t border-gray-100 pt-8 mt-6 space-y-8">
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 shadow-xl md:shadow-none md:border-none md:relative md:p-0 md:mt-6 z-40 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 bg-amber-50 border border-amber-100 p-4 rounded-2xl">
    ...
    {{-- Script para gestionar el guardado local y el Toast --}}
    <script>
        ...
        function addToInterestList(id, name, image, price) {
            ...
            if (!exists) {
                ...
                // Lanzar la nueva alerta flotante
                showToast(`"${name}" se agregó a tu lista de interés.`, 'success');
            } else {
                // Lanzar alerta de ya agregado

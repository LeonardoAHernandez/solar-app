<x-client-layout>
    ...
    <x-container class="mt-12">        
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <a href="{{ route('client.accommodations.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm px-6 py-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 text-center sm:w-auto w-full">
                + Agregar Propiedad
            </a>
        </div>
        ...
        {{-- ========================================== --}}
        <form action="{{ route('client.accommodations.index') }}" method="GET" class="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs mb-8">
            ...
            <div id="advanced-filters" class="mt-5 pt-5 border-t border-gray-100 hidden">
                ...
                @if(request()->hasAny(['search', 'capacity', 'services', 'tags']))
                    <div class="flex justify-end mt-4 pt-4 border-t border-gray-50">
                        <a href="{{ route('client.accommodations.index') }}" class="text-xs text-red-500 font-semibold hover:underline">
        ...
        <div class="space-y-6">
            ...
            @empty
                <div class="bg-white rounded-2xl border border-dashed border-gray-200 p-12 text-center shadow-xs">
                    ...
                    <a href="{{ route('client.accommodations.index') }}" class="text-xs bg-gray-100 px-3 py-1.5 rounded-md font-bold text-gray-700 hover:bg-gray-200">Reestablecer Búsqueda</a>
                </div>
            @endforelse
        </div>
    </x-container>
